...
region_available = ones(5,1); % Indicate which of the 5 regions the driver is avilable to go
...
[x,obj_ip,time_ip] = Solve_IP(max_hours_per_week,time_slot_available,region_available,avg_revenue_trip,p_max,p_min);